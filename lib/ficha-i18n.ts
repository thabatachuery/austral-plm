...
const EN: Record<string, string> = {
  ...
  "APROVADO": "APPROVED",
  "Aprovado": "Approved",
  "REPROVADO": "NOT APPROVED",
  "Reprovado": "Not approved",
  "APROVADO COM RESTRIÇÃO": "APPROVED WITH COMMENTS",
  "Aprov. c/ restrição": "Appr. w/ comments",
  "LIBERADO": "APPROVED",
  "Liberado": "Approved",
  "LIBERADO C/ RESTRIÇÃO": "APPROVED W/ COMMENTS",
  "Liberado c/ restrição": "Appr. w/ comments",
  "APROVADA IDEM PILOTO": "APPROVED SAME AS SAMPLE",
  "Aprov. Idem Piloto": "Appr. same as sample",
  "LIBERADA DIRETO MOSTRUÁRIO": "APPROVED DIRECT TO SMS",
  "Liberada Direto": "Appr. direct",
  "APROVADA IDEM MOSTRUÁRIO": "APPROVED SAME AS SMS",
  "Aprov. Idem Mostr.": "Appr. same as SMS",
  "COR NOVA - ENVIAR BANDEIRA": "NEW COLOR - SEND COLOR SAMPLE",
  "Cor Nova": "New color",
  "REPROVADA - ENVIAR BANDEIRA CORRIGIDA": "NOT APPROVED - SEND CORRECTED COLOR SAMPLE",
  "Reprovada": "Not approved",
  "Liberado com restrição — verificar pontos em vermelho antes de produção.":
    "Approved with comments — check the points in red before production.",
  ...
  "Estágio da ficha": "Tech pack stage",
  "Desenvolvimento": "Development",
  "Mostruário": "SMS",
  "Produção": "Production",
  ...
  "⚠ ATENÇÃO: SE AS ALTERAÇÕES SOLICITADAS NÃO FOREM FEITAS, A PEÇA PODE SER DEVOLVIDA":
    "⚠ WARNING: IF THE REQUESTED CHANGES ARE NOT MADE, THE GARMENT MAY BE RETURNED",
  "✗ PEÇA REPROVADA — FAVOR CORRIGIR CONFORME ANOTAÇÕES DE PROVA":
    "✗ GARMENT NOT APPROVED — PLEASE CORRECT AS PER FITTING COMMENTS",
  "ATENÇÃO — Liberado com Restrição": "WARNING — Approved with Comments",
